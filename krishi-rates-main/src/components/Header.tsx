        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            <Button
              ...
              className="relative"
              onClick={() =>
                toast({ title: getTranslation("notificationsTitle", language) || "Notifications", description: "You have 3 new notifications" })
              }
            >
              <Bell className="w-5 h-5" />
              <Badge className="absolute -top-1 -right-1 w-5 h-5 p-0 text-xs bg-warning">3</Badge>
            </Button>
